...
import com.uniovi.web.services.ws.auth.jwt.JwtTokenFactory;
import com.uniovi.web.services.ws.auth.model.JwtToken;
...
public class AuthSuccessHandler
	...
	@Autowired
	public AuthSuccessHandler(final ObjectMapper mapper,
